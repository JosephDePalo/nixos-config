...
#  D E F A U L T
    ...
    Key([mod], "r", lazy.spawn("sh -c ~/Configs/rofi/launcher.sh"), desc="Launcher"),
    Key([mod], "p", lazy.spawn("sh -c ~/Configs/rofi/power.sh"), desc="Power menu"),
...
def autostart():
    subprocess.call(["sh", "Configs/qtile/autostart_once.sh"])
